...
const Index = () => {
  return (
    <div>
      ...
      />
      <PageHeader pageTitle={{pTitle1:"Labour Supply"}} />
      ...
      <Services
        img={{
          ...
          iTitle2:  <div className=" list-none"><li>Construction</li> <li className="text-[1.07rem]">(Industrial Setup / Infrastructure Setup)</li></div>,
