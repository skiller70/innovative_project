...
const Index = () => {
  return (
    <div>
      ...
      />
      <PageHeader pageTitle={<div className=" list-none"><li className="text-center">Construction</li> <li className=" text-[3rem] font-medium">(Industrial Setup / Infrastructure Setup)</li> </div>}/>
