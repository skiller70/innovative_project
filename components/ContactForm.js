...
const ContactForm = () => {
    return (
        <div className=" mx-[4rem] pt-[4.5rem] mb-[8.75rem]">
                ...
                {/* ****************************************** */}
                <div className=" mt-[4.063rem] grid grid-cols-12">
            {/* ******************************* input */}
        ...
        <div> 
            ...
            <div  className=" flex col-span-7 items-center">
                {/* ******************* */}
            <div className="pl-[5.063rem] flex  justify-between ">
            ...
            <div className=" text-[1.20rem] mt-[2rem] list-none">
                ...
                {/* *********************** */}
                <div className=" rounded-[0.75rem] p-[2rem] bg-[#F4F4F4] shadow-xl  ml-[4.688rem]"> 
